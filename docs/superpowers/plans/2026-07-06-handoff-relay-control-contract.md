...
- [x] **Step 1: Add the Review/Status co-occurrence tie-breaker**
...
- [x] **Step 2: Add `Target repo:` to the relay block**
...
- [x] **Step 3: Define `Target repo:` and preserve `Target:` meaning**
...
- [x] **Step 4: Harden `not-ready` relay authority**
...
- [x] **Step 5: Add the control-contract plan/review gate and in-flight staging boundary**
...
- [x] **Step 6: Verify the manual contract vocabulary**
...
- [x] **Step 1: Record the landed doctrine increment**
...
- [x] **Step 2: Bump plugin metadata to 0.4.8**
...
- [x] **Step 3: Add durable backlog trackers for F2 and F4**
...
- [x] **Step 4: Keep F2, F3, and F4 out of this implementation scope**
...
- [x] **Step 1: Add stable imported-manual token checks**
...
- [x] **Step 2: Keep existing broad relay assertions**
...
- [x] **Step 1: Run whitespace and token verification**
...
- [x] **Step 2: Confirm the implementation scope**
...
- [x] **Step 3: Prepare the final handoff block**
...
- [x] **Step 4: Commit final plan checkbox updates only if the implementation updated this plan**
