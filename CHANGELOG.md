...
Public release history for `agent-skills`.

Detailed tool-development candidates, historical specs, implementation plans,
and review evidence live outside this public source repo after the 2026-07
public cleanup. Public changes that depend on private evidence carry
public-safe attestations and private promotion-ledger mappings.
...
- Release history note (2026-07-08): annotated tag `v0.5.10` was published
  ...
  are not backfilled; treat this note as the current release-state record for
  that batch.
