...
require_contains .claude-plugin/plugin.json '"version": "0.5.11"'
require_contains .claude-plugin/marketplace.json '"version": "0.5.11"'
...
[ "$(cat "$TMP/target/.agent-skills/pin")" = "CCC0509/agent-skills@v0.5.11" ] \
  || fail "pin did not resolve v0.5.11"
