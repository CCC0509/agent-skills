...
[`11-relay-fields.md`](11-relay-fields.md) §3.1; do not fork those rules
here.
...
2. **plan / spec gate before implementation**: Normative doctrine, relay,
   ...
   exact-text approval gate defined by `11-relay-fields.md` §3.1.
...
[`11-relay-fields.md`](11-relay-fields.md) §3.1. Install mechanics remain in
...
remain in [`11-relay-fields.md`](11-relay-fields.md) §3.1.
...
§3.4 Reviewed-Range Carry-Forward And Universal Fresh Gate Discipline moved
to [`26-fresh-gate.md`](26-fresh-gate.md) for length (`40-maintenance.md`
§4's ~250-line cap); no rule text changed. §3.5 Workflow Adoption
Framework, §4 Public Evidence Hygiene, and Evidence Seeds moved to
[`27-workflow-adoption.md`](27-workflow-adoption.md). Read both in order
after this file; §-numbers and rule text are unchanged, only the file
split is new.
